...
class Events(commands.Cog):
    ...
    async def on_guild_join(self, guild: discord.Guild):
        ...
        print(f"{F.RESET}[{F.YELLOW}{self.bot.user.name}{F.RESET}] {F.LIGHTBLACK_EX}Joined server {F.GREEN}{guild} ({guild.id}){F.RESET}")
    ...
    async def on_guild_remove(self, guild: discord.Guild):
        ...
        print(f"{F.RESET}[{F.YELLOW}{self.bot.user.name}{F.RESET}] {F.LIGHTBLACK_EX}Left server {F.RED}{guild} ({guild.id}){F.RESET}")
    ...
    async def on_member_join(self, member: discord.Member):
        ...
        print(f"{F.RESET}[{F.YELLOW}{self.bot.user.name}{F.RESET}] {F.LIGHTBLACK_EX}{user} {F.LIGHTBLACK_EX}joined server {F.GREEN}{guild} ({guild.id}){F.RESET}")
    ...
    async def on_member_remove(self, member: discord.Member):
        ...
        print(f"{F.RESET}[{F.YELLOW}{self.bot.user.name}{F.RESET}] {F.LIGHTBLACK_EX}{user} {F.LIGHTBLACK_EX}left server {F.RED}{guild} ({guild.id}){F.RESET}")
    ...
    async def on_command(self, ctx: commands.Context):
        ...
        print(f"{F.RESET}[{F.YELLOW}{self.bot.user.name}{F.RESET}] {F.LIGHTBLACK_EX}Executed command {F.YELLOW}{command.name}{F.LIGHTBLACK_EX} at {F.CYAN}{self.get_channel_name(ctx.channel)}")
