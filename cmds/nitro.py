...
def status_color(status: str) -> tuple[Colour, str]:
...
Channel: **{get_channel_name(msg.channel)}** {msg.channel.jump_url}
...
{F.WHITE}|{F.LIGHTBLACK_EX} {F.YELLOW}{get_channel_name(msg.channel)}{F.RESET}\n""")
