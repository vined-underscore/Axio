...
class Errors(commands.Cog):
    ...
    async def error(
        ...
        if self.bot.cfg["logging"]["error_logging"]:
            print(f"{F.RESET}[{F.YELLOW}{self.bot.user.name}{F.RESET}] {F.LIGHTBLACK_EX}Error in command {F.YELLOW}{ctx.command.name}{F.LIGHTBLACK_EX}: {F.RED}{error}")
